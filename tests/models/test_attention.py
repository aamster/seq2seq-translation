...
from seq2seq_translation.models.attention.multi_head_attention import (
    _MultiHeadAttention,
)
...
class TestMultiHeadAttention:
    ...
    def test__create_attn_mask(self, key_pad_mask, is_causal, expected):
        a = _MultiHeadAttention(n_embd=2, n_head=1, qkv_dim=8, is_causal=is_causal)
        attn_mask = a._create_attn_mask(
            key_padding_mask=key_pad_mask, T_k=key_pad_mask.shape[1], T_q=4
        )
